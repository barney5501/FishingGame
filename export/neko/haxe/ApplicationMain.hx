...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("FishingGame", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("FishingGame", null, 1920, 1080);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "FishingGame";
		app.meta["name"] = "FishingGame";
